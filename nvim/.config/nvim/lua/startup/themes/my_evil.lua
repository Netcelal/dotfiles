-- Startup theme Evil with small optimizations
local settings = {
  ...
  body = {
    ...
    margin = 5,
    content = {
      {" Find File", "Telescope git_files", "<leader>ff"},
      {" Find Wor", "Telescope live_grep", "<leader>fw"},
      {" Recent Files", "Telescope oldfiles", "<leader>of"},
      {" File Browser", "Telescope find_files", "<leader>fl"},
